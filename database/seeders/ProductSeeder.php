...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create(['id' => 1, 'name' => 'Kas Limón', 'price' => '1.80', 'product_type_id' => 1, 'description' => 'Cuando haces pop, ya no hay stop.']);
        Product::create(['id' => 2, 'name' => 'Alhambra', 'price' => '1.50', 'product_type_id' => 2, 'description' => 'Primavera Sound.']);
        Product::create(['id' => 3, 'name' => 'Ámbar 1900', 'price' => '2.00', 'product_type_id' => 2, 'description' => 'Extorsionado a hosteleros.']);
