...
Route::get('/products/up/{id}', [ProductController::class, 'up']);
Route::get('/products/down{id}', [ProductController::class, 'down']);
Route::get('/products/remove{id}', [ProductController::class, 'remove']);
